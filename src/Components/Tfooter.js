    ...
    return (
        <tfoot>
            <tr id='tr'>
                ...
                <td id='td-footer' className='align-middle'>R${orcamento.subTotal}</td>
            </tr>
            ...
            <tr id='tr'>
                ...
                <input onChange={handleChange} type="checkbox" id="pagamentoAntecipado" name="pagamentoAntecipado"/>
                <label htmlFor="pagamentoAntecipado">PAGAMENTO ANTECIPADO</label>
                </td>
                <td id='td-footer' className='align-middle'>(-R${(orcamento.subTotal*0.05).toFixed(2)})</td>
            </tr>
            <tr id='tr'>
                <td id='td-footer' className='align-middle'></td>
                <td id='td-footer' className='align-middle'></td>
                ...
                <td id='td-footer' className='align-middle'>R${orcamento.total}</td>
            </tr>
        </tfoot>
    )
}
