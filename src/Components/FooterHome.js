        ...
        <footer className="d-flex flex-wrap justify-content-between py-3 my-4 border-top">
            <div className="col d-flex align-items-center">
                ...
                <ol style={{paddingLeft: '2rem'}}>
                    <li>Respeitar o <span style={{ fontWeight: 'bold' }}>PEDIDO MINIMO DE  R${pedidoMinimo.valor}</span> </li>
                    <li>Previsao de entrega em <span style={{ fontWeight: 'bold' }}> dias {login.previsaoEntrega} úteis</span></li>
                    {login.creditoAprovado ? <li>Seu crédito é de <span style={{ fontWeight: 'bold' }}>R${login.creditoAprovado}</span> </li>: ''}
                    <li>Condição de pagamento e crédito não validados pela ferramenta. Entrar em contato com o vendedor.</li>
                    <li>Essa ferramenta trabalha com preço estimado. Valores serão validados pelo consultor de vendas.</li>
                </ol>
