...
export const Header = () => {
    ...
    return (
        <Row className='justify-content-center align-items-center text-center header'>
            <Col>
                <h3 className='h3Header' onClick={()=>dispatch(changePage('meusOrcamentos'))}>Meus Orcamentos</h3>
            </Col>
            <Col>
                <h3 className='h3Header' onClick={()=>dispatch(changePage('home'))}>Orcamento Atual</h3>
            </Col>
            <Col>
